...
def create_charts(
    ...
    ax.set(title="Si2H6 flow and mean film thickness\n400 W, 400 C, 30 s", xlabel="Si2H6 flow (sccm)", ylabel="Mean thickness (Å)")
    ...
    ax.set(title="Process-condition variation", xlabel="Si2H6 flow (sccm)", ylabel="Mean thickness ± 1 SD (Å)")
    ...
    fig.colorbar(points, ax=ax, label="Thickness (Å)")
    ax.set_aspect("equal")
